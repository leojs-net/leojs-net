...
👨 - De lá pra cá, não parei mais de programar ... <br>

## O Que Estou Fazendo Agora 👀

Atualmente, minhas principais ocupações incluem:

📰 - Escrever conteúdo técnico para a plataforma .NET no site [RocketPlay](https://www.rocketplay.com.br).
➕ - Construir a **Automatizei**, uma plataforma para auxiliar empresas na automação de processos de negócios uma maneira padronizada.
🚧 - Atuar como programador freelancer.
